...
$_POST['last_name'] = trim($_POST['last_name']);
	try {
		...
		if (strlen($_POST['first_name']) >2 ) {
			...
			if ($check == 0 ) {
				if ($email_check == 0) {
					if (strlen($_POST['password']) >1 ) {
						...
						$_POST['password'] = ucwords($_POST['password']);
			...
			throw new Exception('Lastname must be minimmum 2 characters!');
		}
		}else {
			throw new Exception('Firstname must be minimmum 2 characters!');
		}
...
<html>
	<head>
		<title>Welcome to ECart Shopping</title>
			...
			<div class="">
				<div id="srcheader">
					<form id="newsearch" method="get" action="http://www.google.com">
					        <input type="text" class="srctextinput" name="q" size="21" maxlength="120"  placeholder="Search ECart..."><input type="submit" value="search" class="srcbutton" >
					</form>
